          ...
          <tr>
            ...
            <td>
                <a href="{{URL::to('view-order/'.$order->order_id)}}" class="active styling-edit" ui-toggle-class="">
                 ...
                 <a onclick="return confirm('Bạn Có Muốn Xóa Đơn Hàng Này Không?')" href="{{URL::to('delete-order/'.$order->order_id)}}" class=" active styling-edit">
